  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-ink/80">
        A decade of INFORM&apos;s <strong>Violent Conflict Probability</strong> score (0–10). The map
        shows where the model expects conflict each year — drag through 2017→2026 and watch the Sahel
